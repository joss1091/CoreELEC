...
PKG_NAME="module.thetvdb"
PKG_VERSION="1.0.12"
#PKG_SHA256="33edd6ba4d7b52b9f3eb810311fc468689aac8c412358dc8e66c85876aecab5b"
PKG_LICENSE="GPL"
PKG_SECTION="script"
PKG_SITE="https://coreelec.org"
PKG_URL="https://mirrors.kodi.tv/addons/leia/script.module.thetvdb/$PKG_SECTION.$PKG_NAME-$PKG_VERSION.zip"
PKG_DEPENDS_TARGET="toolchain Python2 module.requests module.simplejson module.simplecache module.arrow"
...
post_makeinstall_target() {
	...
	$TOOLCHAIN/bin/python -Wi -t -B $TOOLCHAIN/lib/$PKG_PYTHON_VERSION/compileall.py $ADDON_INSTALL_DIR/lib/ -f
